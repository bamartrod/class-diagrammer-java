...
and is independent of the JDK running the tool (runtime 21 can parse
sources 8).
...
**Zero dependencies.** Only a **JDK 21** is needed. No Maven, Gradle or third-party
...
./classdiagrammer.sh ~/spring-framework/spring-web --java 21 -o diagrams/spring-web.json
./classdiagrammer.sh --help
```

`--java` selects the Java parser (default 8). Runtime is always 21.
...
## 4. Architecture (hexagonal, Java 21)
