...
y es independiente del JDK que ejecuta la herramienta (runtime 8 puede analizar
fuentes 8).
...
* JDK 8 (`java-8-openjdk`), compilado con `javac --release 8`
...
## 4. Arquitectura (hexagonal, Java 8)
