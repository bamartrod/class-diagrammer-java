...
public final class CohesionRule implements Rule {
    ...
    @Override public List<String> requiredInputs() { return java.util.Collections.singletonList("RESOURCE_OWNERSHIP"); }
    @Override public List<String> requiredEvidenceKinds() { return java.util.Collections.singletonList("RESOURCE_OWNERSHIP"); }
