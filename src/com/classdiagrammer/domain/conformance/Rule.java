...
public interface Rule {
     ...
     */
    default List<String> dependencies() { return java.util.Collections.emptyList(); }
    ...
    default EvaluationResult evaluate(CodeGraph graph, List<Evidence> evidences) {
        ...
        if (!appl) {
            return new EvaluationResult(ruleId(), false, requiredInputs(), java.util.Collections.emptyList(),
    ...
    default String traceability(String detail) {
