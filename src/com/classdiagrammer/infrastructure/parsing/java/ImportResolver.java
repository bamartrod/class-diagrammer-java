...
final class ImportResolver {
    ...
    private static final Set<String> JAVA_LANG = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(
    ...
    static List<String> requiredImports(String typeSignature, List<String> classImports) {
        ...
        if (typeTokens.isEmpty()) return Collections.emptyList();
    ...
    static List<String> requiredImportsForMethod(String returnType, List<String> paramTypes, List<String> classImports) {
        ...
        Set<String> dedup = new HashSet<String>(required);
        List<String> sorted = new ArrayList<String>(dedup);
        Collections.sort(sorted);
        return Collections.unmodifiableList(sorted);
    }
