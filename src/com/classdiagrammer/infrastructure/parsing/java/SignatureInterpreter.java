...
final class SignatureInterpreter {
    ...
    SignatureInterpreter(String simpleName, TypeKind kind, boolean isEnum) { this(simpleName, kind, isEnum, List.of()); }
    ...
    SignatureInterpreter(String simpleName, TypeKind kind, boolean isEnum, List<String> classImports) {
        ...
        this.classImports = classImports == null ? List.of() : List.copyOf(classImports);
    }
