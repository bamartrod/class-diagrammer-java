...
public final class JavaArtifactParser implements ArtifactParser {
    ...
    private List<String> filterHierarchyImports(List<String> imports, HeaderParser.ParsedHeader header) {
        if (imports == null || imports.isEmpty()) return java.util.Collections.emptyList();
        java.util.Set<String> hierarchySimpleNames = new java.util.HashSet<String>();
        ...
        if (hierarchySimpleNames.isEmpty()) return java.util.Collections.emptyList();
        ...
        return java.util.Collections.unmodifiableList(new ArrayList<String>(filtered));
    }
