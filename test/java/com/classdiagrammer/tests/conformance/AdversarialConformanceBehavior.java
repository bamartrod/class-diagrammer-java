...
public final class AdversarialConformanceBehavior {
    ...
    public static void verify(TestHarness h) {
        ...
        h.expect("Fixture A — conformant implementation yields CONFORMANT", () -> {
            CodeGraph graph = CodeGraph.of(java.util.Arrays.asList(
        ...
        h.expect("Fixture B — deliberate violation yields NON_CONFORMANT", () -> {
            TypeNode violating = TypeNode.named("com.classdiagrammer.domain.Violating", "Violating")
                    ...
                    .importing(java.util.Arrays.asList("com.classdiagrammer.infrastructure.json.JsonWriter"))
                    .withFields(java.util.Arrays.asList(
                            com.classdiagrammer.domain.model.Field.named("w", "JsonWriter", Visibility.PRIVATE, java.util.Collections.singleton("private"), java.util.Arrays.asList("com.classdiagrammer.infrastructure.json.JsonWriter"))
                    ))
                    .build();
            CodeGraph graph = CodeGraph.of(java.util.Arrays.asList(violating));
        ...
        h.expect("Fixture C — missing required evidence yields UNDECIDABLE", () -> {
            ...
            Rule missingFactRule = new Rule() {
                ...
                public List<String> requiredInputs() { return java.util.Collections.singletonList("MISSING_FACT_KIND"); }
                public List<String> requiredEvidenceKinds() { return java.util.Collections.singletonList("MISSING_FACT_KIND"); }
                public Boolean evaluatePredicate(CodeGraph g, List<Evidence> e) { return true; }
                public boolean isSupported() { return true; }
            };
            ConformanceEngine engine = new ConformanceEngine(java.util.Collections.singletonList(missingFactRule));
            ConformanceResult cr = engine.evaluate(graph, java.util.Collections.emptyList(), java.util.Collections.emptyList());
        ...
        h.expect("Mandatory pair — same rule CONFORMANT vs NON_CONFORMANT with traceability", () -> {
            ...
            TypeNode violating = TypeNode.named("com.classdiagrammer.domain.Violating2", "Violating2")
                    ...
                    .withFields(java.util.Arrays.asList(
                            com.classdiagrammer.domain.model.Field.named("x", "JsonWriter", Visibility.PRIVATE, java.util.Collections.singleton("private"), java.util.Arrays.asList("com.classdiagrammer.infrastructure.json.JsonWriter"))
                    ))
                    .importing(java.util.Arrays.asList("com.classdiagrammer.infrastructure.json.JsonWriter"))
                    .build();
            CodeGraph gConformant = CodeGraph.of(java.util.Arrays.asList(conformant));
            CodeGraph gViolating = CodeGraph.of(java.util.Arrays.asList(violating));
            EdgeResolver resolver = new EdgeResolver();
        ...
        h.expect("Aggregate precedence — NON_CONFORMANT dominates", () -> {
            Rule cRule = new Rule() {
                ...
                public boolean isApplicable(CodeGraph g, List<Evidence> e) { return true; }
                public List<String> requiredInputs() { return java.util.Collections.emptyList(); }
                public List<String> requiredEvidenceKinds() { return java.util.Collections.emptyList(); }
                public Boolean evaluatePredicate(CodeGraph g, List<Evidence> e) { return true; }
                public boolean isSupported() { return true; }
            };
            ...
            ConformanceEngine engine = new ConformanceEngine(java.util.Arrays.asList(cRule, ncRule));
            CodeGraph graph = CodeGraph.of(java.util.Arrays.asList(
