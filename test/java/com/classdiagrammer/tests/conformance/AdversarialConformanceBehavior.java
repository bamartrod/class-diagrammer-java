...
public final class AdversarialConformanceBehavior {
    ...
    public static void verify(TestHarness h) {
        ...
        h.expect("Mandatory pair — same rule CONFORMANT vs NON_CONFORMANT with traceability", () -> {
            ...
            List<Evidence> evC = List.of(new Evidence(new ImplementationFact(FactKind.TYPE_EXISTS, conformant.qualifiedName(), "com/classdiagrammer/domain/Conformant.java:1", "CLASS", "CSAS-003-U2"), "com/classdiagrammer/domain/Conformant.java", "TypeNode", "EVID-C1"));
            List<Evidence> evV = List.of(new Evidence(new ImplementationFact(FactKind.TYPE_EXISTS, violating.qualifiedName(), "com/classdiagrammer/domain/Violating2.java:1", "CLASS", "CSAS-003-U2"), "com/classdiagrammer/domain/Violating2.java", "TypeNode", "EVID-V1"));
